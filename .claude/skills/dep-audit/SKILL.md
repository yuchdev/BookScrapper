---
name: dep-audit
description: Dependency audit for Book Scrapper. Invoke on changes to pyproject.toml / uv.lock / requirements.txt, or on a weekly cadence, or manually as /dep-audit. Runs a CVE scan and a license-compatibility check and delegates the deep write-up to the background-reviewer agent.
